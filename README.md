This is the MEDIAL feedback plugin for Moodle 4.x and higher
...
2 - Copy the contents of the zip file which contains this readme.txt into the moodle/mod/assign/feedback
